/*=============================================================================
#  Author:          Md Mehrab Hossain Opi (BrehamPie)
#  Problem Name:    30-E
#  Judge:           Codeforces
#  Created On:      11:47:54 24-12-2021
=============================================================================*/
...
const int mx = 1e5 + 5;
int d[2][mx];
// d[0][i] - even length palindrome - d[i]*2
// d[1][i] - odd length palindrome - 1+d[i]*2 

void manacher( const string& s ) {
    int n = s.size();
    for (int z = 0; z < 2; z++) {
        for (int i = 0, l = 0, r = 0; i < n; i++) {
            int t = r - i + !z; // center থেকে কত দূরে 
