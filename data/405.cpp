...
inline point rotate(const point &x,double angle){  //����ת�Ƕ�
...
inline pair<point,point> cross_circle(const circle &O,const point &x){  //��Բ���е�
...
struct hash{
	...
	void build(int Len=9,int p=11)  //len����  hashsize=p
	{
