...
void manacher(int n, char *s) {
	...
	// for(int i=1; i<=n; ++i) printf("%2d", d[i]); puts("");
}
...
void getnext(int n, char *s) {
	...
	// for(int i=1; i<=n; ++i) printf("%2c", s[i]); puts("");
	// for(int i=1; i<=n; ++i) printf("%2d", next[i]); puts("");
}
...
int main() {
	...
	// for(int i=1; i<=n; ++i) printf("%2c", s[i]); puts("");
	// for(int i=1; i<=n; ++i) printf("%2d", match[i]); puts("");
	// for(int i=1; i<=n; ++i) printf("%2d", mm[i]); puts("");
