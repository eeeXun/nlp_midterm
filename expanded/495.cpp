...
# 117 "data/495.cpp"
       "d != 0"
# 117 "data/495.cpp" 3 4
       , "data/495.cpp", 117, __extension__ __PRETTY_FUNCTION__))
# 117 "data/495.cpp"
                     ;
...
# 123 "data/495.cpp"
       "d != 0"
# 123 "data/495.cpp" 3 4
       , "data/495.cpp", 123, __extension__ __PRETTY_FUNCTION__))
# 123 "data/495.cpp"
                     ;
        if (d < 0) tie(n, d) = make_pair(-n, -d);
        return n / d + ((n > 0) && (n % d));
...
# 138 "data/495.cpp"
                             "it != v.end() && *it == x"
# 138 "data/495.cpp" 3 4
                             , "data/495.cpp", 138, __extension__ __PRETTY_FUNCTION__))
# 138 "data/495.cpp"
                                                              ; return it - v.begin();
    }
...
# 190 "data/495.cpp"
       "0 <= i && i < j && j <= SZ"
# 190 "data/495.cpp" 3 4
       , "data/495.cpp", 190, __extension__ __PRETTY_FUNCTION__))
# 190 "data/495.cpp"
                                         ;
...
# 225 "data/495.cpp"
       "0 <= index && index < SZ"
# 225 "data/495.cpp" 3 4
       , "data/495.cpp", 225, __extension__ __PRETTY_FUNCTION__))
# 225 "data/495.cpp"
                                       ;
...
# 230 "data/495.cpp"
       "0 <= index && index < SZ - 1"
# 230 "data/495.cpp" 3 4
       , "data/495.cpp", 230, __extension__ __PRETTY_FUNCTION__))
# 230 "data/495.cpp"
                                           ;
...
# 240 "data/495.cpp"
       "0 <= pos && pos + len <= SZ"
# 240 "data/495.cpp" 3 4
       , "data/495.cpp", 240, __extension__ __PRETTY_FUNCTION__))
# 240 "data/495.cpp"
                                          ;
        if (!width_rmq.SZ)
...
# 361 "data/495.cpp"
       "0 <= i && i < SZ && 0 <= j && j < SZ"
# 361 "data/495.cpp" 3 4
       , "data/495.cpp", 361, __extension__ __PRETTY_FUNCTION__))
# 361 "data/495.cpp"
                                                   ;
        if (i == j) return SZ - i;
...
# 370 "data/495.cpp"
       "0 <= pos && pos + len <= SZ"
# 370 "data/495.cpp" 3 4
       , "data/495.cpp", 370, __extension__ __PRETTY_FUNCTION__))
# 370 "data/495.cpp"
                                          ;
...
int main() {
    ...
    for (int inx = 1; inx < pal.width.size(); inx += 2)
        pal.width[inx] = 0;
    ...
    for (int suff = 0; suff < ((int((second).size()) - 1) / 2 + 1); suff++) {
        int earliest = sa.first_occurence_of(int((second).size()) + 1, suff);
