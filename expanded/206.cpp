...
# 82 "data/206.cpp"
 "x!=y"
# 82 "data/206.cpp" 3 4
 , "data/206.cpp", 82, __extension__ __PRETTY_FUNCTION__))
# 82 "data/206.cpp"
             ;
...
# 88 "data/206.cpp"
                        "1<=i&&i<=n"
# 88 "data/206.cpp" 3 4
                        , "data/206.cpp", 88, __extension__ __PRETTY_FUNCTION__))
# 88 "data/206.cpp"
                                          ;return n+2+n-i;}
int solve1(){
 int ans=1;
...
"0"
# 101 "data/206.cpp" 3 4
, "data/206.cpp", 101, __extension__ __PRETTY_FUNCTION__))
# 101 "data/206.cpp"
         ;
}
...
# 132 "data/206.cpp"
 "len>=1&&len<=i&&i+len-1<=n"
# 132 "data/206.cpp" 3 4
 , "data/206.cpp", 132, __extension__ __PRETTY_FUNCTION__))
# 132 "data/206.cpp"
                                   ;
...
# 172 "data/206.cpp"
  "0"
# 172 "data/206.cpp" 3 4
  , "data/206.cpp", 172, __extension__ __PRETTY_FUNCTION__))
# 172 "data/206.cpp"
           ;
  }
 }
 
# 175 "data/206.cpp" 3 4
(static_cast <bool> (
# 175 "data/206.cpp"
0
# 175 "data/206.cpp" 3 4
...
"0"
# 175 "data/206.cpp" 3 4
, "data/206.cpp", 175, __extension__ __PRETTY_FUNCTION__))
# 175 "data/206.cpp"
         ;
}
int main() {
