...
# 117 "data/878.cpp"
       "d != 0"
# 117 "data/878.cpp" 3 4
       , "data/878.cpp", 117, __extension__ __PRETTY_FUNCTION__))
# 117 "data/878.cpp"
                     ;
...
# 123 "data/878.cpp"
       "d != 0"
# 123 "data/878.cpp" 3 4
       , "data/878.cpp", 123, __extension__ __PRETTY_FUNCTION__))
# 123 "data/878.cpp"
                     ;
        if (d < 0) tie(n, d) = make_pair(-n, -d);
        return n / d + ((n > 0) && (n % d));
...
# 138 "data/878.cpp"
                             "it != v.end() && *it == x"
# 138 "data/878.cpp" 3 4
                             , "data/878.cpp", 138, __extension__ __PRETTY_FUNCTION__))
# 138 "data/878.cpp"
                                                              ; return it - v.begin();
    }
...
# 190 "data/878.cpp"
       "0 <= i && i < j && j <= SZ"
# 190 "data/878.cpp" 3 4
       , "data/878.cpp", 190, __extension__ __PRETTY_FUNCTION__))
# 190 "data/878.cpp"
                                         ;
...
# 225 "data/878.cpp"
       "0 <= index && index < SZ"
# 225 "data/878.cpp" 3 4
       , "data/878.cpp", 225, __extension__ __PRETTY_FUNCTION__))
# 225 "data/878.cpp"
                                       ;
...
# 230 "data/878.cpp"
       "0 <= index && index < SZ - 1"
# 230 "data/878.cpp" 3 4
       , "data/878.cpp", 230, __extension__ __PRETTY_FUNCTION__))
# 230 "data/878.cpp"
                                           ;
...
# 240 "data/878.cpp"
       "0 <= pos && pos + len <= SZ"
# 240 "data/878.cpp" 3 4
       , "data/878.cpp", 240, __extension__ __PRETTY_FUNCTION__))
# 240 "data/878.cpp"
                                          ;
        if (!width_rmq.SZ)
...
# 361 "data/878.cpp"
       "0 <= i && i < SZ && 0 <= j && j < SZ"
# 361 "data/878.cpp" 3 4
       , "data/878.cpp", 361, __extension__ __PRETTY_FUNCTION__))
# 361 "data/878.cpp"
                                                   ;
        if (i == j) return SZ - i;
...
# 370 "data/878.cpp"
       "0 <= pos && pos + len <= SZ"
# 370 "data/878.cpp" 3 4
       , "data/878.cpp", 370, __extension__ __PRETTY_FUNCTION__))
# 370 "data/878.cpp"
                                          ;
