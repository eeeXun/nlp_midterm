...
# 117 "data/142.cpp"
       "d != 0"
# 117 "data/142.cpp" 3 4
       , "data/142.cpp", 117, __extension__ __PRETTY_FUNCTION__))
# 117 "data/142.cpp"
                     ;
...
# 123 "data/142.cpp"
       "d != 0"
# 123 "data/142.cpp" 3 4
       , "data/142.cpp", 123, __extension__ __PRETTY_FUNCTION__))
# 123 "data/142.cpp"
                     ;
        if (d < 0) tie(n, d) = make_pair(-n, -d);
        return n / d + ((n > 0) && (n % d));
...
# 138 "data/142.cpp"
                             "it != v.end() && *it == x"
# 138 "data/142.cpp" 3 4
                             , "data/142.cpp", 138, __extension__ __PRETTY_FUNCTION__))
# 138 "data/142.cpp"
                                                              ; return it - v.begin();
    }
...
# 190 "data/142.cpp"
       "0 <= i && i < j && j <= SZ"
# 190 "data/142.cpp" 3 4
       , "data/142.cpp", 190, __extension__ __PRETTY_FUNCTION__))
# 190 "data/142.cpp"
                                         ;
...
# 225 "data/142.cpp"
       "0 <= index && index < SZ"
# 225 "data/142.cpp" 3 4
       , "data/142.cpp", 225, __extension__ __PRETTY_FUNCTION__))
# 225 "data/142.cpp"
                                       ;
...
# 230 "data/142.cpp"
       "0 <= index && index < SZ - 1"
# 230 "data/142.cpp" 3 4
       , "data/142.cpp", 230, __extension__ __PRETTY_FUNCTION__))
# 230 "data/142.cpp"
                                           ;
...
# 240 "data/142.cpp"
       "0 <= pos && pos + len <= SZ"
# 240 "data/142.cpp" 3 4
       , "data/142.cpp", 240, __extension__ __PRETTY_FUNCTION__))
# 240 "data/142.cpp"
                                          ;
        if (!width_rmq.SZ)
...
# 359 "data/142.cpp"
       "0 <= i && i < SZ && 0 <= j && j < SZ"
# 359 "data/142.cpp" 3 4
       , "data/142.cpp", 359, __extension__ __PRETTY_FUNCTION__))
# 359 "data/142.cpp"
                                                   ;
        if (i == j) return SZ - i;
...
# 368 "data/142.cpp"
       "0 <= pos && pos + len <= SZ"
# 368 "data/142.cpp" 3 4
       , "data/142.cpp", 368, __extension__ __PRETTY_FUNCTION__))
# 368 "data/142.cpp"
                                          ;
