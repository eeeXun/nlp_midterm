...
# 5 "data/68.cpp"
using namespace std;
int n, nxt[200005], len[200005], mn[200005];
int st[200005][25], mxp[200005][25], bit[200005], mx_pos;
...
int main()
{
 ...
 int l = mn[pos], r = n - pos - 1, d = ans - (pos << 1) + 1 >> 1;
 query(l + d - 1, r - d + 1);
 printf("%d\n", pos ? 3 : 1);
 if (pos)
  printf("%d %d\n", mn[pos] - pos + 1, pos);
